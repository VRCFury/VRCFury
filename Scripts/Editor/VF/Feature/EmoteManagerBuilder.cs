    ...
    public void Apply() {
        ...
        if (this == allBuildersInRun.OfType<EmoteManagerBuilder>().First()){
            ...
            var t = new Model.Feature.Toggle {
                ...
                hasTransition = true,
                transitionStateIn = model.afkState,
                transitionStateOut = model.afkState,
        ...
        foreach (var e in model.standingEmotes) {
            var t = new Model.Feature.Toggle {
                ...
                hasTransition = true,
                transitionStateIn =  model.standingState,
                transitionStateOut = e.resetAnimation ?? model.standingState,
        ...
        foreach (var e in model.sittingEmotes) {
            var t = new Model.Feature.Toggle {
                ...
                state = e.emoteAnimation,
                hasTransition = true,
                transitionStateIn = model.sittingState,
                transitionStateOut = e.resetAnimation ?? model.sittingState,
                enableExclusiveTag = true,
                exclusiveTag = "VF-Managed-Emote",
                isButton = !e.isToggle,
                simpleOutTransition = false,
