...
namespace VF.Service {
    ...
    internal class ActionClipService {
        ...
        public BuiltAction LoadStateAdv(string name, State state, VFGameObject animObjectOverride = null, MotionTimeMode motionTime = MotionTimeMode.Never) {
            var result = LoadStateAdv(name, state, avatarManager.AvatarObject, animObjectOverride ?? avatarManager.CurrentComponentObject, this, motionTime);
        ...
        public static BuiltAction LoadStateAdv(string name, State state, VFGameObject avatarObject, VFGameObject animObject, [CanBeNull] ActionClipService service = null, MotionTimeMode motionTime = MotionTimeMode.Never) {
            if (state == null) {
        ...
        private static AnimationClip LoadAction(string name, Action action, AnimationClip offClip, VFGameObject avatarObject, VFGameObject animObject, [CanBeNull] ActionClipService service) {
            if (action == null) {
