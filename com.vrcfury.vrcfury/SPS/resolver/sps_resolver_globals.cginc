...
UNITY_INSTANCING_BUFFER_START(SpsResolverGlobals)
    ...
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagInclude1Low)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagInclude1High)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagInclude2Low)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagInclude2High)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagInclude3Low)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagInclude3High)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagInclude4Low)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagInclude4High)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagExclude1Low)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagExclude1High)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagExclude2Low)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagExclude2High)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagExclude3Low)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagExclude3High)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagExclude4Low)
    UNITY_DEFINE_INSTANCED_PROP(float, _SPS_TagExclude4High)
...
#define _SPS_TagInclude1Low SPS_RESOLVER_GLOBAL_PROP(_SPS_TagInclude1Low)
#define _SPS_TagInclude1High SPS_RESOLVER_GLOBAL_PROP(_SPS_TagInclude1High)
#define _SPS_TagInclude1 SPS_MERGE_SPLIT(_SPS_TagInclude1)
#define _SPS_TagInclude2Low SPS_RESOLVER_GLOBAL_PROP(_SPS_TagInclude2Low)
#define _SPS_TagInclude2High SPS_RESOLVER_GLOBAL_PROP(_SPS_TagInclude2High)
#define _SPS_TagInclude2 SPS_MERGE_SPLIT(_SPS_TagInclude2)
#define _SPS_TagInclude3Low SPS_RESOLVER_GLOBAL_PROP(_SPS_TagInclude3Low)
#define _SPS_TagInclude3High SPS_RESOLVER_GLOBAL_PROP(_SPS_TagInclude3High)
#define _SPS_TagInclude3 SPS_MERGE_SPLIT(_SPS_TagInclude3)
#define _SPS_TagInclude4Low SPS_RESOLVER_GLOBAL_PROP(_SPS_TagInclude4Low)
#define _SPS_TagInclude4High SPS_RESOLVER_GLOBAL_PROP(_SPS_TagInclude4High)
#define _SPS_TagInclude4 SPS_MERGE_SPLIT(_SPS_TagInclude4)
#define _SPS_TagExclude1Low SPS_RESOLVER_GLOBAL_PROP(_SPS_TagExclude1Low)
#define _SPS_TagExclude1High SPS_RESOLVER_GLOBAL_PROP(_SPS_TagExclude1High)
#define _SPS_TagExclude1 SPS_MERGE_SPLIT(_SPS_TagExclude1)
#define _SPS_TagExclude2Low SPS_RESOLVER_GLOBAL_PROP(_SPS_TagExclude2Low)
#define _SPS_TagExclude2High SPS_RESOLVER_GLOBAL_PROP(_SPS_TagExclude2High)
#define _SPS_TagExclude2 SPS_MERGE_SPLIT(_SPS_TagExclude2)
#define _SPS_TagExclude3Low SPS_RESOLVER_GLOBAL_PROP(_SPS_TagExclude3Low)
#define _SPS_TagExclude3High SPS_RESOLVER_GLOBAL_PROP(_SPS_TagExclude3High)
#define _SPS_TagExclude3 SPS_MERGE_SPLIT(_SPS_TagExclude3)
#define _SPS_TagExclude4Low SPS_RESOLVER_GLOBAL_PROP(_SPS_TagExclude4Low)
#define _SPS_TagExclude4High SPS_RESOLVER_GLOBAL_PROP(_SPS_TagExclude4High)
#define _SPS_TagExclude4 SPS_MERGE_SPLIT(_SPS_TagExclude4)
