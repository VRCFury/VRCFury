...
_SPS_Target_Center("Target Tri-Center", Float) = 0
_SPS_Target_Forward("Target Tri-Forward", Float) = 0
_SPS_Target_Up("Target Tri-Up", Float) = 0
_SPS_Target_Right("Target Tri-Right", Float) = 0
_SPS_Front_Center("Front Tri-Center", Float) = 0
_SPS_Front_Forward("Front Tri-Forward", Float) = 0
_SPS_Front_Up("Front Tri-Up", Float) = 0
_SPS_Front_Right("Front Tri-Right", Float) = 0
